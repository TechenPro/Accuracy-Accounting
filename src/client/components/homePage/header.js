        ...
        return (
            <div className = 'header-btn-holder'>
                < div className='header-btn-holder-left' >
                    ...
                    < div className = 'header-btn' > < a className = 'header-btn-link'href = "/insights" > Insights </a></div >
                ...
                < div className='header-btn-holder-right' >
                    ...
                    <div className='header-btn'><a className='header-btn-link' href="/contact">Contact</a></div>
